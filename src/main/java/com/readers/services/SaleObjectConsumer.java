...
public interface SaleObjectConsumer {
	...
	/**
	 * Called once per SaleObject. This method must be called with objects ordered by the attribute decided by a call to
	 * getPriorityOrderAttribute()
	 *
	 * @param squareMeters        The size of the house or apartment in square meters.
	 * @param pricePerSquareMeter The price of the house or apartment divided by square meters. The price must always
	 *                            have exactly three decimals and must not contain a decimal separator. So 1USD = 1000,
	 *                            2075.4USD = 2075400, 1.511USD = 1511 and so on.
	 ...
	 *
	 * @throws TechnicalException if any problem occurs during the invocation resulting in the object not being reported
	 *                            successfully.
	 */
